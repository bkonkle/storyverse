...
export type ProfileDataFragment = {__typename?: 'Profile'} & Pick<
  Profile,
  'id' | 'displayName' | 'email' | 'picture' | 'createdAt' | 'updatedAt'
>
...
export type AllProfilesQuery = {__typename?: 'Query'} & {
  allProfiles?: Maybe<
    {__typename?: 'ProfilesConnection'} & {
...
export type ProfileByIdQuery = {__typename?: 'Query'} & {
  profileById?: Maybe<{__typename?: 'Profile'} & ProfileDataFragment>
}
...
export type UpdateProfileByIdMutation = {__typename?: 'Mutation'} & {
  updateProfileById?: Maybe<
...
export type AllUsersQuery = {__typename?: 'Query'} & {
  allUsers?: Maybe<
    {__typename?: 'UsersConnection'} & {
      nodes: Array<{__typename?: 'User'} & UserDataFragment>
    }
  >
}
...
export type UserByIdQuery = {__typename?: 'Query'} & {
  userById?: Maybe<{__typename?: 'User'} & UserDataFragment>
}
...
export const AllProfilesDocument = gql`
  query allProfiles($condition: ProfileCondition) {
    allProfiles(condition: $condition) {
      nodes {
        ...ProfileData
      }
    }
...
export function useAllProfilesQuery(
  options: Omit<Urql.UseQueryArgs<AllProfilesQueryVariables>, 'query'> = {}
) {
  return Urql.useQuery<AllProfilesQuery>({
...
export function useProfileByIdQuery(
  options: Omit<Urql.UseQueryArgs<ProfileByIdQueryVariables>, 'query'> = {}
) {
  return Urql.useQuery<ProfileByIdQuery>({
...
export function useUpdateProfileByIdMutation() {
  return Urql.useMutation<
